//
//  FirstSecondTimeSheetTableViewCell.swift
//  MinskMetroSchedule
//
...
protocol FirstSecondTimeSheetTableViewCellProtocol {
    func configureCell(hourValue: String,
                       minutesValue: String)
}

class FirstSecondTimeSheetTableViewCell: UITableViewCell, FirstSecondTimeSheetTableViewCellProtocol {
    
    static let key = "FirstSecondTimeSheetTableViewCell"
