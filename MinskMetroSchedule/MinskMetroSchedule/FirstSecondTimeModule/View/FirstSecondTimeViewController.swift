//
//  FirstSecondTimeViewController.swift
//  MinskMetroSchedule
//
...
protocol FirstSecondTimeViewControllerProtocol: AnyObject {
    //ViewController methods here
    var presenter: FirstSecondTimeViewPresenter? {get}
...
class FirstSecondTimeViewController: UIViewController, FirstSecondTimeViewControllerProtocol {
    
    var numberOfRow: Int = 0 {
        didSet {
            FirstSecondTimeSheetTableView.reloadData()
        }
    }
    var presenter: FirstSecondTimeViewPresenter?
    var line: String?
    ...
    private lazy var FirstSecondTimeSheetTableView: UITableView = {
        let tableView = UITableView()
        tableView.delegate = self
        tableView.dataSource = self
        tableView.register(FirstSecondTimeSheetTableViewCell.self, forCellReuseIdentifier: FirstSecondTimeSheetTableViewCell.key)
    ...
    override func viewDidLoad() {
        ...
        view.addSubview(FirstSecondTimeSheetTableView)
...
//        }
        ...
        FirstSecondTimeSheetTableView.snp.makeConstraints {
        ...
        fullScheduleLabel.snp.makeConstraints {
            $0.centerX.equalToSuperview()
            $0.top.equalTo(FirstSecondTimeSheetTableView.snp.bottom).offset(10)
        }
...
extension FirstSecondTimeViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let cell = FirstSecondTimeSheetTableView.dequeueReusableCell(withIdentifier: FirstSecondTimeSheetTableViewCell.key, for: indexPath) as? FirstSecondTimeSheetTableViewCell {
            presenter?.configureFirstSecondTimeSheetTableViewCell(indexPath: indexPath, cell: cell, stationName: stationName , toStation: toStationName, line: lineValue)
